...
std::vector<float> BLESDR::sample_for_raw_packet(size_t chan, int counter)
{
	...
	uint8_t packet[] = {0x40, 0x1E, 0x8A, 0xCE, 0xEE, 0xB7, 0x69, 0x88, 0x07, 0x1C, 0xB9, 0x16, 0x54, 0x2F, 0x61, 0xAC, 0xCC, 0x27, 0x45, 0x67, 0xF7, 0xDB, 0x34, 0xC4, 0x03, 0x8E, 0x5C, 0x0B, 0xAA, 0x97, 0x30, 0x56, 0x00, 0x00, 0x00};
/*
0x40, 0x14,                               // header
...
*/
	...
	*(int32_t*)(packet + 12) = htonl(counter);
